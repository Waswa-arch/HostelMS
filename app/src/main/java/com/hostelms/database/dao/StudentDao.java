...
public interface StudentDao {
    ...
    @Query("SELECT * FROM students WHERE id=:id") Student getById(int id);
    ...
    @Query("UPDATE students SET roomId=:roomId, bedNumber=:bed, hostelName=:hostelName, roomNumber=:roomNumber, roomType=:roomType WHERE id=:studentId")
    void assignRoom(int studentId, int roomId, int bed, String hostelName, String roomNumber, String roomType);
}
